    ...
    def command(shell: DTShell, args):
        ...
        if "resize" in parsed.steps:
            ...
            run_cmd(
                [
                    ...
                    sd_card.loopdev,
                    "resizepart",
                    str(DISK_IMAGE_PARTITION_TABLE["root"]),
                    "100%",
                ]
            )
                ...
                try:
                    ...
                    try:
                        output = run_cmd_in_partition(
                            "root", 'echo "Hello from an ARM chroot!"', get_output=True
                        )
        ...
        if "docker" in parsed.steps:
            ...
            try:
                ...
                remote_docker_dir = os.path.join(PARTITION_MOUNTPOINT("root"), "var", "lib", "docker")
