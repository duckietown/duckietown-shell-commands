...
class DTCommand(DTCommandAbs):
    ...
    def command(shell: DTShell, args):
        prog = "dts duckiebot led_control DUCKIEBOT_NAME"
        usage = """
LED control:
...
"""
        ...
        parser.add_argument("hostname", default=None, help="Name of the Duckiebot to light up")
...
def run_gui_controller(hostname, image, duckiebot_ip, network_mode):
    ...
    params = {
        ...
        "stdin_open": True,
        "tty": True,
        "command": LED_COMMAND.format(mode="gui", veh=hostname),
        "detach": True,
        "volumes": volumes,
    }
...
def run_cli_controller(hostname, image, duckiebot_ip, network_mode, sim):
    ...
    params = {
        ...
        "stdin_open": True,
        "tty": True,
        "command": LED_COMMAND.format(mode="cli", veh=hostname),
        "detach": True,
    }
