...
def _resolve_host_runner_endpoint(verbose: bool = False) -> tuple[str, str, float]:
    ...
    while True:
        ...
        for url, token, timeout in endpoint_candidates:
            if verbose and url not in announced_urls:
