...
DD_BLOCK_SIZE = "1M"
DD_BLOCK_SIZE_MAC = "1m" # Mac doesn't like capital letters
...
def step_flash(_, parsed, data):
    ...
    if running_on_mac:
        ...
        DD_BLOCK_SIZE=DD_BLOCK_SIZE_MAC
        LIST_DEVICES_CMD="diskutil list"
    else:
    ...
    if not running_on_mac:
        dd_cmd.prepend["sudo", "diskutil", "unmount", "{}".format(parsed.device)]
